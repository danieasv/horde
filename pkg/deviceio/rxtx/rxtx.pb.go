...
func (*UnimplementedRxtxServer) PutMessage(ctx context.Context, req *UpstreamRequest) (*DownstreamResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PutMessage not implemented")
}
func (*UnimplementedRxtxServer) GetMessage(ctx context.Context, req *DownstreamRequest) (*DownstreamResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetMessage not implemented")
}
func (*UnimplementedRxtxServer) Ack(ctx context.Context, req *AckRequest) (*AckResponse, error) {
...
func (*UnimplementedRADIUSServer) Access(ctx context.Context, req *AccessRequest) (*AccessResponse, error) {
